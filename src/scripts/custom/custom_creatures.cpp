...
// ---### ZONES ###---
        ...
        case 4002:// Teleport to Molten Core
            player->CLOSE_GOSSIP_MENU();
            player->TeleportTo(0, -7515.640137f, -1045.300049f, 182.300522f, 0.6f);
            break;
...
bool GossipHello_EnchantNPC(Player* player, Creature* creature)
{
    ...
    player->ADD_GOSSIP_ITEM(5, "Shield / Offhand", GOSSIP_SENDER_MAIN, EQUIPMENT_SLOT_OFFHAND);
...
bool GossipSelect_EnchantNPC(Player* player, Creature* creature, uint32 sender, uint32 action)
{
    ...
    if (action < 20)
    {
        ...
        case EQUIPMENT_SLOT_WRISTS:
            ...
            player->ADD_GOSSIP_ITEM(5, "Greater Intellect", GOSSIP_SENDER_MAIN, BRACER_INTELLECT);
            break;
